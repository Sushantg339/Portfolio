...
import { ChevronLeft, ChevronRight, Copy, MoveRight, PanelLeft, Plus, Search, ShareIcon, ShieldHalf } from "lucide-react"
                    ...
                    {blogPosts.map(({id , image , date , link ,title})=>(
                        <div key={id} className='blog-post'>
                            <div className="col-span-2">
                                <img src={image} className="object-fit h-full w-full" alt={title} />
                            </div>
